...
<center><h2>商品添加<a style="float:right;" href="{{url('/goods')}}" class="btn btn-success">列表</a></hr></h2><hr/></center>
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="goods_no" id="firstname" 
           placeholder="请输入商品货号">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="goods_nums" id="firstname" 
           placeholder="请输入商品库存">
