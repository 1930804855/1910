...
<body>
<center><h2>分类添加<a style="float:right;" href="{{url('/category')}}" class="btn btn-success">列表</a></hr></h2><hr/></center>

<form action="{{url('/category/addDo')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
@csrf
<!-- {{csrf_field()}}
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
           <input type="radio" name="is_show_nav" value="1">显示
